...
public:
    ...
    */
     ...
     */
    void applyLinear(OIIO::ImageBuf& image, Triple neutral, const bool sourceIsRaw = false, const bool useColorMatrixOnly = false);
...
private:
    ...
    Matrix getCameraToACES2065Matrix(const Triple& asShotNeutral, const bool sourceIsRaw = false, const bool useColorMatrixOnly = false);
